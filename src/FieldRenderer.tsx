 ...
 */
export function FieldRenderer({ name, field, value, onChange, overrides }: FieldRendererProps) {
  ...
  return <Component name={name} field={field} value={value} onChange={onChange} />;
}
